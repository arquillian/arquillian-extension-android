...
public class ConfiguratorTestCase extends AbstractTestTestBase {
    ...
    public void skipConfiguration() throws Exception {
        ...
        ArquillianDescriptor desc = Descriptors.create(ArquillianDescriptor.class)
                .extension(AndroidExtensionConfigurator.ANDROID_EXTENSION_NAME).property("skip", "true");
        ...
        AndroidExtensionConfiguration configuration = getManager().getContext(SuiteContext.class).getObjectStore()
                .get(AndroidExtensionConfiguration.class);
        ...
        assertEventFired(AndroidExtensionConfigured.class, 0);
    }
    ...
    public void missingAvdOrSerialId() throws Exception {
        ...
        // set mocks
        ArquillianDescriptor desc = Descriptors.create(ArquillianDescriptor.class)
                .extension(AndroidExtensionConfigurator.ANDROID_EXTENSION_NAME).property("skip", "false");
    ...
    public void invalidPlatformConfiguration() throws Exception {
        ...
        // assert Android SDK event was passed
        assertEventFired(AndroidExtensionConfigured.class, 1);
    }
