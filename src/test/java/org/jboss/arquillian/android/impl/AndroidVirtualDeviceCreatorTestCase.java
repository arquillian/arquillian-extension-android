...
public class AndroidVirtualDeviceCreatorTestCase extends AbstractTestTestBase {
    ...
    public void setMocks() {
        ArquillianDescriptor desc = Descriptors.create(ArquillianDescriptor.class)
                .extension(AndroidSdkConfigurator.ANDROID_SDK_EXTENSION_NAME).property("force", "true")
                .property("apiLevel", "9").property("verbose", "true").property("avdName", "foobar-test-device");
